    ...
    n.innerHTML = `
      <div class="container">
        <a class="navbar-brand" href="${url("index.html")}">
          <img
            src="${url("img/BuhoWise-logo-navbar-final.png")}" 
            alt="BuhoWise Logo"
          >
        </a>
  ...
  function accessibility() {
    ...
    p.innerHTML = `
      ...
      <div class="accessibility-grid">
        ...
        <button type="button" data-bw-accessibility="stop">
          <i class="bi bi-volume-mute"></i> Stop
        </button>
        <button type="button" data-bw-accessibility="text-up">
          <i class="bi bi-zoom-in"></i> Text +
        </button>
        <button type="button" data-bw-accessibility="text-down">
          <i class="bi bi-zoom-out"></i> Text -
        </button>
        ...
        <button type="button" data-bw-accessibility="dyslexia">
          <i class="bi bi-fonts"></i> Dyslexia
        </button>
